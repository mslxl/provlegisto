...
enum RunProgramFlag { RPF_PAUSE_CONSOLE = 0x0001, RPF_REDIRECT_INPUT = 0x0002 };
...
vector<string> GetCommand(int argc, char **argv, bool &reInp,
                          bool &pauseAfterExit) {
...
int main(int argc, char **argv) {
  ...
  printf("\n--------------------------------");
  printf("\nProcess exited after %.4g seconds with return value %d, %ld KB mem "
         "used.\n",
